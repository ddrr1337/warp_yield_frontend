...
3. The message is received by the Master Contract on the Ethereum network, and the corresponding aWRP tokens are automatically minted for the user on the Arbitrum network.
