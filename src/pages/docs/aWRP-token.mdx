...
| :----- | :----: | 
| Ethereum Sepolia |<div className="flex flex-nowrap"><span className="-mb-0.5 text-blue">{dataContracts[11155111].master}</span><CopyButton text={dataContracts[11155111].master} /></div>|
