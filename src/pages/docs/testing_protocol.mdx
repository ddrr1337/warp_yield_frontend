...
Warp Yield is in **TEST** mode and is assuming that **ChainLink** will **ALWAYS** send messages correctly.
It is **IMPERATIVE** to implement a security system in case **ChainLink** fails to deliver the messages correctly, to prevent users lose their capital.
