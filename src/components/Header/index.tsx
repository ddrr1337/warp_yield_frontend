      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <Logo isFooter={false} isSticky={sticky} isHomePage={isHomePage} />
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                >
                  <span>
                    <svg
                      viewBox="0 0 16 16"
                      className={`hidden h-[22px] w-[22px] fill-current  ${!sticky && pathUrl === "/" ? "hover:fill-black" : "hover:fill-blue"}   dark:block`}
                    >
                    ...
                    <svg
                      viewBox="0 0 23 23"
                      className={`h-[30px] w-[30px] fill-current text-dark  ${!sticky && pathUrl === "/" ? "hover:fill-black" : "hover:fill-blue"}  dark:hidden ${
